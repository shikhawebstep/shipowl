...
export default function List() {
    ...
    const fetchUsers = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/staff`,
                {
                    method: "GET",
                    headers: {
    ...
    const trashedUsers = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/staff/trashed`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/staff/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleRestore = useCallback(async (item) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/staff/${item?.id}/restore`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/staff/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
