...
export default function Update() {
    ...
    const fetchRole = useCallback(async () => {
        ...
        const admintoken = supplierData?.security?.token;
        if (!admintoken) {
            router.push("/supplier/auth/login");
            return;
        }
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/role/${id}`,
                {
                    method: "GET",
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `${process.env.NEXT_PUBLIC_API_BASE_URL}api/supplier/role/${id}`;
            ...
            Swal.fire({
                ...
                if (res.isConfirmed) {
                    ...
                    router.push("/supplier/permission/role");
                }
            });
        } catch (error) {
