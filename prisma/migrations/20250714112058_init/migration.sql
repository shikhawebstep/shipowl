...
CREATE TABLE `supplierBanner` (
    ...
    INDEX `supplierBanner_createdBy_idx`(`createdBy`),
    INDEX `supplierBanner_updatedBy_idx`(`updatedBy`),
    INDEX `supplierBanner_deletedAt_idx`(`deletedAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
